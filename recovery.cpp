...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  // HERTZIFY_VERSION_APPEND_TIME_OF_DAY is set to true has the desired date.
  std::string ver = android::base::GetProperty("ro.hertzify.version", "");
  ...
  std::vector<std::string> title_lines = {
    "Version " + android::base::GetProperty("ro.hertzify.build.version", "(unknown)") +
        " (" + ver_date + ")",
  };
